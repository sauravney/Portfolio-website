      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="max-w-3xl">
          <AnimatedSection animation="fadeIn">
            <Badge variant="outline" className="px-4 py-1 text-xs font-medium bg-primary/10 text-primary mb-6">
          ...
          >
            <p className="text-lg md:text-xl text-foreground/70 leading-relaxed">
              I design and build modern web applications with a focus on user experience,
          ...
          >
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <ResumeButton resumePath="/resume.pdf" />
